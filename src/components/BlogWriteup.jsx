...
function BlogWriteup() {
  return (
    <div>
        <div className='m-0 pt-[90px] md:m-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4'>
                <div className='rounded-2xl overflow-hidden md:block m-1'>
                    <img className='object-cover w-full h-[232px]' src={Group4} alt="" />
                    <div className='bg-B-writeup py-3 pl-6 pr-4'>
        ...
        <div className='flex justify-center items-center'><button className='bg-baddhia-orange py-2 px-9 mb-28 uppercase text-white text-lg font-semibold rounded-full'><Link to="/BlogContent">Read more article</Link></button></div>
    </div>
  )
}
