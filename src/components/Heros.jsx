  ...
  return (
    <div className='relative'>
      <div className="h-[7vh]"></div>
            <img className='w-full h-[40vh]' src={hero} alt="" />
        ...
        >
          <button
            type="submit"
            className="bg-baddhia-orange p-2 xl:px-12 px-6 rounded-[16px] font-semibold xl:text-base text-[10px] text-white transition-all duration-300 hover:scale-105"
          >
            Download Now
          </button>
        </a>
