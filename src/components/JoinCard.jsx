...
function JoinCard() {
  return (
    <div className="bg-[url('/images/joinBack.png')] h-[fit] w-full bg-center bg-no-repeat flex xl:flex-row flex-col xl:items-center justify-center pt-20 mx-auto p-10 xl:gap-[84px] gap-[34px]">
