...
function JoinCard() {
  return (
    <div className="bg-[url('/images/joinBack.png')] h-[100vh] xl:h-fit w-full bg-center xl:mt-0 md:mb-0 bg-no-repeat flex md:flex-row flex-col md:items-center justify-center mx-auto p-10 xl:py-40 md:gap-[84px] gap-[34px] bg-cover">
