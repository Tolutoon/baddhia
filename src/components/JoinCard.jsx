...
function JoinCard() {
  return (
    <div className="bg-[url('/images/joinBack.png')] h-[80vh] w-full bg-center bg-no-repeat flex xl:flex-row flex-col xl:items-center justify-center pt-20 mx-auto p-10 xl:gap-[84px] gap-[34px]">
      ...
      <form >
        ...
        <input type="name" placeholder="Your Email" className="p-4 md:w-[400px] w-[80vw]"/>
        </div>
      </form>
    </div>
  );
