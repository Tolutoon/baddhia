...
function JoinCard() {
  return (
    <div className="bg-[url('/images/joinBack.png')] h-[100vh] xl:h-fit w-full bg-center mb-[-105px] xl:mb-0 bg-no-repeat flex xl:flex-row flex-col xl:items-center justify-center mx-auto p-10 xl:gap-[84px] gap-[34px]">
